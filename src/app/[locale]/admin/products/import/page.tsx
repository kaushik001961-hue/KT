  ...
  products.forEach(
    (product, index) => {
      ...
      if (
        ...
        errors.push(
          `Row ${row}: Product type must be IMPORT or EXPORT.`
        );
      }
...
export default function ImportProductsPage() {
  ...
  async function processImportFile(
    ...
    try {
      ...
      let parsedProducts: ImportProduct[] =
        [];
            ...
            <div className="p-16 text-center">
              ...
              <p className="mx-auto mt-2 max-w-md text-sm text-[var(--foreground)]/50">
                ...
                statusFilter !==
                  ...
                  : "Start building your import catalogue by adding your first product."}
                        ...
                        >
                          ...
                          <td className="px-5 py-5">
                            ...
                            <div className="flex justify-end gap-2">
                              ...
                              <Link
                                href={`/products/import/${product.slug}`}
                                target="_blank"
