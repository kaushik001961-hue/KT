          ...
          {importCategories.length === 0 ? (
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
              ...
              {importCategories.map((category) => (
                ...
                >
                  {/* IMAGE with fixed relative wrapper */}

                  <div className="relative h-56 w-full overflow-hidden bg-[var(--primary-light)]">
                    ...
                    <div className="absolute bottom-4 left-4 z-10 rounded-full bg-white/90 px-3 py-1 text-[10px] font-bold uppercase tracking-[0.15em] text-[#c9a24d] backdrop-blur">
                      Import
                    </div>
                  </div>
              ...
              {exportCategories.map((category) => (
                ...
                >
                  ...
                  <div className="relative h-56 w-full overflow-hidden bg-[var(--primary-light)]">
                    ...
                    <div className="absolute bottom-4 left-4 z-10 rounded-full bg-white/90 px-3 py-1 text-[10px] font-bold uppercase tracking-[0.15em] text-[#1455a0] backdrop-blur">
                      Export
                    </div>
                  </div>
