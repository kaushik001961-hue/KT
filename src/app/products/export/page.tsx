  ...
  return (
    <main className="gradient-section overflow-hidden">
      ...
      <section className="relative overflow-hidden px-5 pb-16 pt-28 sm:pb-20 sm:pt-32 lg:px-8">
        ...
        <div className="pointer-events-none absolute -left-32 top-10 h-96 w-96 rounded-full bg-[#68b0ff]/10 blur-3xl" />

        <div className="pointer-events-none absolute -right-32 bottom-0 h-80 w-80 rounded-full bg-[#c9a24d]/10 blur-3xl" />
        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-base leading-8 text-[var(--foreground)]/65 sm:text-lg">
              Browse our currently published export
              products and explore international market
              opportunities through Krupali Traders
              Private Limited.
            </p>
            ...
            <div className="grid items-center gap-10 lg:grid-cols-[1fr_1fr] lg:gap-16">
              ...
              <div>
                ...
                <p className="mt-5 leading-8 text-[var(--foreground)]/65">
                  We focus on connecting quality
                  products with suitable international
                  markets through dependable trade
                  relationships.
                </p>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="gradient-card gradient-border rounded-3xl p-6">
                  ...
                  <p className="mt-2 text-sm leading-6 text-[var(--foreground)]/60">
                    ...
                    international buyers and business
                    opportunities.
                  </p>
                ...
                <div className="gradient-card gradient-border rounded-3xl p-6">
                  ...
                  <p className="mt-2 text-sm leading-6 text-[var(--foreground)]/60">
                    Focused on dependable product sourcing,
                    coordination and international supply
                    requirements.
                  </p>
      ...
      <section className="px-5 pb-24 sm:pb-28 lg:px-8">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-[#07111f] via-[#0b3266] to-[#1455a0] p-8 text-white shadow-2xl sm:p-10 lg:p-14">

            <div className="pointer-events-none absolute -bottom-24 -left-24 h-72 w-72 rounded-full bg-[#68b0ff]/10 blur-3xl" />
            ...
            <div className="relative max-w-3xl">
              ...
              <p className="mt-5 leading-8 text-white/70">
                Tell us about your product and
                international market requirements and
                discuss the next opportunity with us.
              </p>

              <Link
                href="/contact"
                className="mt-8 inline-flex w-full items-center justify-center gap-2 rounded-full bg-white px-7 py-3.5 font-semibold text-[#0b3266] transition duration-300 hover:-translate-y-1 hover:shadow-xl sm:w-auto"
              >
                Send an Enquiry
                <ArrowRight size={18} />
              </Link>
